...
@click.option('--pg-host', default='pgdatabase', help='PostgreSQL host')   # 'localhost' while developing, 'pgdatabase' while running in docker-compose
...
def main(pg_user, pg_pass, pg_host, pg_port, pg_db, chunksize, target_table):
    """Insert NYC Taxi Zones data into PostgreSQL database"""
